...
const Crypto = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ImageBackground
         source={require('../../assets/5-L.jpeg')}
         style={styles.coverImage}
       >
         {/* Top Overlay */}
         <View style={styles.topOverlay}>
           <Text style={styles.overlayText}>Crypto</Text>
           <Text style={styles.overlayText}>RECOLECCIÓN, SUBIDA Y ENVÍO</Text>
         </View>

         {/* Bottom Overlay */}
         <View style={styles.bottomOverlay}>
             <Text style={styles.overlayText}>Recolección + Envío a Wallet</Text>
             <Text style={styles.overlayText}>Recepción + Bajada a Recurso</Text>
